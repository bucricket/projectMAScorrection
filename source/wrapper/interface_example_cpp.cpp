...
int main(int argc, char **argv) {
    ...
    opts.append(" file_coef ../rtcoef_rttov11/rttov8pred54L/rtcoef_noaa_19_hirs.dat ");
    opts.append(" file_sccld ../rtcoef_rttov11/cldaer/sccldcoef_noaa_19_hirs.dat ");
    ...
    if (err != 0) std::cerr << "Error initialising IR emissivity atlas: atlas will not be used" << std::endl;
    // =================================================================
