...
rtcoef_dir = '../rtcoef_rttov11/'

rtcoef_file = rtcoef_dir + 'rttov8pred54L/rtcoef_noaa_19_hirs.dat'
sccldcoef_file = rtcoef_dir + 'cldaer/sccldcoef_noaa_19_hirs.dat'
...
err = rttov_ir_emis_atlas_setup(emis_atlas_path, month, -1, inst_id, 0)
...
err = rttov_call_direct(inst_id, channel_list, datetimes, angles, surfgeom, surftype, skin, s2m, \
                        simplecloud, icecloud, zeeman, p, t, gas_units, gas_id, gases, surfemisrefl, btrefl, rad)
if err != 0:
