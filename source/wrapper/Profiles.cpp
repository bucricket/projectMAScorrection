...
: nprofiles(nbprofiles), nlevels(nblevels), ngases(nbgases),
    ...
    datetimes(NULL),gas_id(NULL),gas_units(unknown),icecloud(NULL),
...
///@param angles: pointer to an array [nprofiles][4]
...
///@param skin pointer to an array of doubles [nprofiles][9]
...
///       containing ish, idg for each profile
///@param icecloud pointer to an array of double [nprofiles][2]
/// containing ish, idg
...
/// Q=1, O3, CO2, N2O, CO, CH4, CLW=15, CFRAC=20,STCO,STMA,CUCC,CUCP,CUMA,CIRR=30,ICEDE,
...
//                 std::cerr << "warning profile missing icecloud, assigning zero values" << std::endl;
