...
call rttov_read_scattcoeffs (err, coef_rttov%coef, coef_scatt)
...
call rttov_alloc_rad       ( err, nchannels, radiance, nlev-1_jpim,        1_jpim)   
...
call rttov_alloc_scatt_prof(      nchannels, cld_profiles_k, nlev, .false._jplm, 1_jpim, init = .true._jplm)
call rttov_alloc_rad       ( err, nchannels,     radiance_k, nlev-1_jpim,        1_jpim)   
...
call rttov_alloc_rad          ( err, nchannels, radiance, nlev-1_jpim,   0_jpim)   
call rttov_alloc_prof         ( err, nchannels, profiles_k, nlev, opts,    0_jpim)
call rttov_alloc_scatt_prof   (      nchannels, cld_profiles_k, nlev, .false., 0_jpim)
call rttov_alloc_rad          ( err, nchannels, radiance_k, nlev-1_jpim,   0_jpim)  
