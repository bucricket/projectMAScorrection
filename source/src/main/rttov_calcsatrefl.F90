...
!- End of header ------------------------------------------------------
  ...
  ! Solar_spectrum contains the top-of-atmosphere solar spectral irradiance for each channel
  ! (corrected for the Earth-sun distance if the profile has an associated date), with units mW/m2/cm-1.
  ! This is multiplied by cos(sol_zen_ang) to obtain the surface irradiance.
  ! The factor of 1/pi is present to convert from a BRDF to the output BRF.
