...
!  1.11      04/06/2014  Make a FASTEM-6 using M. Kazumori RWD model (A Geer)
!  1.12      05/06/2015  Allow foam_fraction input (L-F Meunier)
!
...
! the version choosen is given by coef%fastem_ver value
  ...
  IF (opts%rt_mw%fastem_version >= 1 .AND. opts%rt_mw%fastem_version <= max_fastem_version) THEN
    wanted_fastem_ver = opts%rt_mw%fastem_version
  ELSE
