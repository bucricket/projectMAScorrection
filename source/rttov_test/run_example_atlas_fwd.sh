...
TEST_DIR=./test_example_atlas_fwd.1

# Paths relative to the rttov_test/${TEST_DIR} directory:
BIN_DIR=../../$BIN                           # BIN directory (may be set with BIN= argument)
REF_TEST_DIR=../test_example_atlas_fwd.2     # Test reference data
COEF_DIR=../../rtcoef_rttov11/rttov9pred54L  # Coefficients directory
